  ...
  return <main>
    ...
    <div className="shell">
      ...
      <nav className="feature-tabs">
        ...
        <button className={tab === "mail" ? "active" : ""} onClick={() => setTab("mail")}><b>02</b><span><strong>Mail 寄送</strong><small>一份 PDF 對一個 Email</small></span></button>
      </nav>
      {tab === "encrypt" ? <EncryptionTab /> : <SingleMailTab />}
      <footer><span>兩項功能獨立</span><span>AES-256 PDF 加密</span><span>一附件一收件人</span><span>寄送後刪除附件</span></footer>
    </div>
  </main>;
}
